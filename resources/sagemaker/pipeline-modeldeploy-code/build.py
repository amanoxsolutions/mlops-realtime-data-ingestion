...
def extend_config(args, model_package_arn, stage_config):
    ...
    new_params = {
        ...
        "DataCaptureUploadPath": "s3://"
        + args.s3_bucket
        + "/datacapture-"
        + stage_config["Parameters"]["StageName"],
    }
    new_tags = {
...
def get_pipeline_custom_tags(args, sm_client, new_tags):
    try:
        response = sm_client.describe_project(ProjectName=args.sagemaker_project_name)
...
if __name__ == "__main__":
    ...
    model_package_arn = get_latest_approved_package(args.model_package_group_name, sm_client)
