...
if __name__ == "__main__":
    ...
    for i in range(30):
        ...
        predictions_data = predictions_with_id(record_uuid, input_data, df_predictions["0.5"].values[i])
        ...
        ground_truth_data = ground_truth_with_id(list(df_input_data[target_col])[i], record_uuid)
